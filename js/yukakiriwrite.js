...
function draw () {
    ...
    // 任意の文字をランダム描画
    ctx.globalAlpha = 0.6;
    var kiri = ['結月ゆかり','東北きりたん','結月きりたん','終末','崩壊','東北三姉妹','ボイスロイド','外宇宙','再帰','eschatology',
'終焉','再構築','再起','パンドラの箱','偽物','Memory leak','Dropout','バイナリ','初期化','審判',
'クリスマス','0×00','セカイの管理者','mariage','ASTER','rollback','断片','最果て','外なる神','crack','継承','破滅','反転','1DD6A','log','平穏',//5*7+2
